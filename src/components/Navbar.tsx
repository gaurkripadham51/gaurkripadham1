        ...
        <div className="flex items-center justify-between h-16">
          ...
          >
            <img
              ...
              src="https://i.ibb.co/fG8TkMNs/logos.png"
              alt="Logo"
            />
            <span className="text-white font-bold text-lg hover:scale-70 transition-transform">
              Shri Sankat Mochan Balaji Mandal (Regd.)
            </span>
          </div>
